import 'package:bit_ascol/screens/Home/questions/q_subject.dart';
...
class QuestionSemScreen extends StatefulWidget {
  const QuestionSemScreen({super.key});

  @override
  _QuestionSemScreenState createState() => _QuestionSemScreenState();
}

class _QuestionSemScreenState extends State<QuestionSemScreen> {
      ...
      if (snapshot.exists) {
        ...
        if (data.isNotEmpty) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('No PDF details found')),
          );
        }
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   onPressed: () {
      //     Navigator.of(context).push(MaterialPageRoute(builder: (context) => CreateQuestions()));
      //   },
