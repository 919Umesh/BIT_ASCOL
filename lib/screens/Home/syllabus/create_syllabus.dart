...
class CreateSyllabus extends StatefulWidget {
  CreateSyllabus({super.key});

  @override
  State<CreateSyllabus> createState() => _CreateSyllabusState();
}

class _CreateSyllabusState extends State<CreateSyllabus> {
  File? _selectedFile;
  String? _pdfUrl;
  String? _semester;
  String? _subject;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Create Syllabus'),
      ),
      body: Padding(
