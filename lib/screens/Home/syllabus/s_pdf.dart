...
class PdfListSyllabusScreen extends StatelessWidget {
  final String semester;
  final String subject;
  final List<Map<String, dynamic>> pdfList;

  const PdfListSyllabusScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    final filteredPdfs = pdfList
        .where((pdf) => pdf['semester'] == semester && pdf['subject'] == subject)
        .toList();
