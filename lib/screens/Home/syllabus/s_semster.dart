import 'package:bit_ascol/screens/Home/syllabus/s_subject.dart';
...
import 'create_syllabus.dart';

class SyllabusSemScreen extends StatefulWidget {
  const SyllabusSemScreen({super.key});

  @override
  _SyllabusSemScreenState createState() => _SyllabusSemScreenState();
}

class _SyllabusSemScreenState extends State<SyllabusSemScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SubjectSemListScreen(
                                  semester: _semesters[index],
                                  pdfList: _pdfList,
                                ),
                              ),
      ...
      //         .push(MaterialPageRoute(builder: (context) => CreateSyllabus()));
      //   },
          ...
          return isAdmin
            ...
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) =>  CreateSyllabus(),
                ),
              );
            },
            child: const Icon(Icons.add),
